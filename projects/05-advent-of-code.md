...
2. **Optional:** Join our [private leaderboard](https://adventofcode.com/2025/leaderboard/private) using the code `1059646-48d5074b`.
...
| ---- | ---- | ---- |
| [2025 Day 1: Secret Entrance](https://adventofcode.com/2025/day/1) | Track a circular safe dial and count how often it lands on 0 (modular arithmetic). | \* |
| [2025 Day 2: Gift Shop](https://adventofcode.com/2025/day/2) | Scan number ranges for "invalid" product IDs — those made of a digit block repeated twice. | \* |
| [2025 Day 3: Maximizing Battery Joltage](https://adventofcode.com/2025/day/3) | Select batteries to maximise total joltage. | \*\* |
| [2025 Day 4: Printing Department](https://adventofcode.com/2025/day/4) | Grid puzzle: count paper rolls a forklift can reach (fewer than four filled neighbours). | \*\* |
| [2025 Day 11: Reactor](https://adventofcode.com/2025/day/11) | Count the distinct paths through a network of devices (memoisation!). | \*\* |
| [2025 Day 12: Christmas Tree Farm](https://adventofcode.com/2025/day/12) | Fit present shapes into the region under each tree (shape packing). | \*\*\* |
...
| [2024 Day 7: Bridge Repair](https://adventofcode.com/2024/day/7) | Try combinations of operators and add a new one — fun. | \*\* |
| [2024 Day 11: Plutonian Pebbles](https://adventofcode.com/2024/day/11) | Stones that change; tricky (memoisation). | \*\* |
| [2024 Day 4: Ceres Search](https://adventofcode.com/2024/day/4) | Find XMAS words in a grid. | \*\*\* |
| [2024 Day 9: Disk Fragmenter](https://adventofcode.com/2024/day/9) | Work in dense format; quite a bit of work. | \*\*\* |
| [2023 Day 6: Wait For It](https://adventofcode.com/2023/day/6) | Compute boat speed. | \* |
| [2023 Day 2: Cube Conundrum](https://adventofcode.com/2023/day/2) | Analyse a small game. | \* |
...
| [2023 Day 10: Pipe Maze](https://adventofcode.com/2023/day/10) | Find your way through a pipe maze (mathematical!). | \*\*\* |
