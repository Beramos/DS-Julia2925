...
First of all, _welcome to these additional exercises, **$(student[:name])**!
"""

# ╔═╡ 6c0f2d10-63dd-11eb-2c17-fddf9cd51bfe
md"""## 1. Trajecting trajectories

Let us start with some backstory for the exercise.
...
begin
   ...
   qb1 = QuestionBlock(;
	...
	questions = [q1],
	hints=[hint(md"The question can be answered without defining your own datatypes and using the all that is available from the `Julia.Base` module"),
...
md"## Convoluted answer to these questions showcasing the 💪️ of Julia"
