...
hints:
- in the `plots` function set `aspect_ratio=:equal` to equalize the x- and y-ax;
- if you have defined a type, you make a [plotting recipe](https://docs.juliaplots.org/latest/recipes/).
"""
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "8a8ed468f2fb39a098c8ec8c9d1e3a6e9b9165f1"
